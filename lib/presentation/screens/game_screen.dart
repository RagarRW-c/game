        ...
        return Scaffold(
          ...
          body: LayoutBuilder(
            builder: (context, constraints) {
              ...
              engine.configureBoardGeometry(boardSize, tileSize);
              final sortedBoardTiles = engine.paintOrderedBoardTiles;
              return Container(
                            ...
                            children: [
                              ...
                              for (final tile in sortedBoardTiles)
                                AnimatedPositioned(
                                  ...
                                  width: tile.renderSize(boardSize, tileSize).width,
                                  height: tile.renderSize(boardSize, tileSize).height,
                                  child: GameTileWidget(
                                    tile: tile,
                                    enabled: !engine.isTileCovered(tile),
